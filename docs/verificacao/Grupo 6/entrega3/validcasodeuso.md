...
<div align="center">
<font size="3"><p style="text-align: center"><b>Tabela 1- </b> Resultado da verificação para itens de padronização e desenvolvimento do projeto (Validação dos Casos de Uso)</p></font>
...
### Resultados obtidos na verificação para o artefato Validação dos Casos de Uso

Na Tabela 2, encontram-se os resultados da verificação presente na lista para o artefato Validação dos Casos de Uso.

<div align="center">
<font size="3"><p style="text-align: center"><b>Tabela 2 - </b> Resultado da verificação do artefato Validação dos Casos de Uso</p></font>
...
### Verificação para o artefato Validação dos Casos de Uso

Nenhum problema foi identificado na verificação realizada para o artefato Validação dos Casos de Uso. 
## Resultados

Nesta seção, serão apresentados os resultados obtidos na verificação do artefato [Validação dos Casos de Uso](https://requisitos-de-software.github.io/2024.2-MeuINSS/modelagem_parte1/validacaoCasodeUso/) por meio de um gráfico de pizza, no qual são apresentadas a quantidade de "Sim", "Não" e "Não se aplica" obtidos durante a verificação.

### Verificação para itens de padronização e desenvolvimento do projeto

No Gráfico 1, está registrado os resultados obtidos na verificação do artefato [Validação dos Casos de Uso](https://requisitos-de-software.github.io/2024.2-MeuINSS/modelagem_parte1/validacaoCasodeUso/) em relação aos itens de padronização e desenvolvimento do projeto.
...
No Gráfico 2, está registrado os resultados obtidos na verificação do artefato [Validação dos Casos de Uso](https://requisitos-de-software.github.io/2024.2-MeuINSS/modelagem_parte1/validacaoCasodeUso/) em relação à verificação do próprio artefato.

<div align="center">
  <p><b>Gráfico 2 - </b> Resultados da verificação para o artefato Validação dos Casos de Uso</p>
    <img src="../imagens/ucgeral.jpg">
    <font size="3"><p style="text-align: center">Autor: <a href="https://github.com/julia-fortunato">Júlia Fortunato</a>, 2025</p></font>
...
No vídeo 1, encontra-se a verificação para o artefato Validação dos Casos de Uso.

<div align="center">

<p style="text-align: center"><a href="https://www.youtube.com/watch?v=FPmf7D1gxjo" target="blanket"><b>Vídeo 1 - </b> Verificação do artefato Validação dos Casos de Uso</a></p>

<iframe width="560" height="315" src="https://www.youtube.com/embed/FPmf7D1gxjo?si=P3qdeJDdavoVwmoA" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
