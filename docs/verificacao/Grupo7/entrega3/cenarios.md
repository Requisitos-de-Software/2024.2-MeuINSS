...
Esta documentação tem como objetivo relatar os resultados da verificação por inspeção do artefato [Cenários](https://requisitos-de-software.github.io/2024.2-Threads/modelagem/Cenarios/) elaborado pelo [Grupo 7](https://requisitos-de-software.github.io/2024.2-Threads/) na disciplina de Requisitos de Software, no semestre de 2024.2. Será analisado o artefato feito pelos integrantes do grupo em sua última versão, 1.1, de 08/12/2024.
...
Nesta seção, serão apresentados os resultados obtidos na verificação do artefato [Cenários](https://requisitos-de-software.github.io/2024.2-Threads/modelagem/Cenarios/) por meio de um gráfico de pizza, no qual são apresentadas a quantidade de "Sim", "Não", "Não se aplica" e "Incompleto" obtidos durante a verificação.

### Verificação para itens de padronização e desenvolvimento do projeto

No Gráfico 1, está registrado os resultados obtidos na verificação do artefato [Cenários](https://requisitos-de-software.github.io/2024.2-Threads/modelagem/Cenarios/) em relação aos itens de padronização e desenvolvimento do projeto.
...
No Gráfico 2, está registrado os resultados obtidos na verificação do artefato [Cenários](https://requisitos-de-software.github.io/2024.2-Threads/modelagem/Cenarios/) em relação à verificação do próprio artefato.
...
A verificação do artefato começa no minuto 7:09.

<div align="center">

<p style="text-align: center"><a href="https://youtu.be/b1xOiMnnvI4?si=7tRo4Kb_fjQXYsLo&t=429" target="blanket"><b>Vídeo 1 - </b> Verificação do artefato Casos de Uso</a></p>

<iframe width="560" height="315" src="https://www.youtube.com/embed/b1xOiMnnvI4?si=7tRo4Kb_fjQXYsLo" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
