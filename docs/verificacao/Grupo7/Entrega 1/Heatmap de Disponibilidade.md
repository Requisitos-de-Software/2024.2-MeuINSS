...
O presente documento tem por finalidade mostrar quais foram os resultados obtidos a partir da verificação realizada sobre o artefato Heatmap de Disponibilidade que foi desenvolvido na entrega 1 do projeto (Planejamento do Projeto) pelo grupo 7.
