...
Esta documentação tem como objetivo relatar os resultados da verificação por inspeção do artefato [Personas](https://requisitos-de-software.github.io/2024.2-Threads/Elicitacao/personas/) elaborado pelo [Grupo 7](https://requisitos-de-software.github.io/2024.2-Threads/) na disciplina de Requisitos de Software, no semestre de 2024.2. Será analisado o artefato feito pelos integrantes do grupo em sua última versão, 1.0, de 20/11/2024.
...
<div align="center">
<font size="3"><p style="text-align: center"><b>Tabela 1- </b> Resultado da verificação para itens de padronização e desenvolvimento do<br> projeto (Personas)</p></font>
...
### Resultados obtidos na verificação para o artefato Personas

Na Tabela 2, encontram-se os resultados da verificação presente na lista para o artefato Personas.

<div align="center">
<font size="3"><p style="text-align: center"><b>Tabela 2 - </b> Resultado da verificação do artefato Personas</p></font>
<table>
  <thead>
    <tr>
      <th>ID</th>
  ...
  <tbody>
    ...
    <tr>
      <td>3</td>
      <td>Seus objetivos (que também podem incluir objetivos fora do domínio da aplicação)?</td>
      <td>Sim</td>
    </tr>
    <tr>
      <td>4</td>
