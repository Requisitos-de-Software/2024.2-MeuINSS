...
|   História de Usuário   |    Tema    |      Critérios de aceitação     |    Prioridade    |   DI   |
| ----------------------- | ---------- | ------------------------------- | ---------------- | ------ |
| Eu, como usuário do aplicativo do INSS, desejo poder realizar pedidos como por exemplo solicitação de benefícios (aposentadoria, auxilio-doença, pensão por morte, salário-maternidade, seguro desemprego), atualização de dados, agendamento de perícia médica.| Funcionalidades Gerais.| - O sistema deve permitir ao usuário realizar os pedidos relativos ao que se refere os serviços do INSS. </br> - O sistema deve ser capaz de mostrar ao usuário o histórico de pedidos realizados pelo mesmo identificando os detalhes de cada pedido. </br> - Caso o usuário não tenha conseguido solicitar um pedido o sistema deve informá-lo.| Alta | Alta |
...
|   História de Usuário   |    Tema    |      Critérios de aceitação     |    Prioridade    |   DI   |
| ----------------------- | ---------- | ------------------------------- | ---------------- | ------ |
| Eu, como usuário do aplicativo do INSS, desejo que o aplicativo do "Meu INSS" esteja integrado com outros sistemas como, por exemplo, o sistema jurídico.| Funcionalidades Gerais. |- O sistema deve estar integralizado com outros sistemas além do próprio INSS. </br> - O usuário deve ter acesso a interações/informações de outros sistemas dentro do aplicativo do "Meu INSS".| Alta | Alta |
...
|   História de Usuário   |    Tema    |      Critérios de aceitação     |    Prioridade    |   DI   |
| ----------------------- | ---------- | ------------------------------- | ---------------- | ------ |
| Eu, como usuário do aplicativo do INSS, desejo poder solicitar o auxílio doença através do sistema.| Planejamento Previdenciário e Benefícios. |- O sistema deve permitir que seja possível solicitar o auxílio doença. </br> - O usuário deve poder acompanhar o seu pedido de auxílio doença no aplicativo.| Alta | Médio|
...
| **História de Usuário**                                                                                       | **Tema**                   | **Critérios de Aceitação**                                                                                                                                                                                                                                             | **Prioridade** | **DI** |
|---------------------------------------------------------------------------------------------------------------|----------------------------|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|----------------|--------|
| Eu, como usuário do Meu INSS, desejo utilizar um assistente virtual para simular diferentes cenários previdenciários. | Comunicação e Informações. | - O assistente deve estar disponível no menu principal;<br>- O usuário deve poder simular cenários. <br>- Os dados devem ser preenchidos pelo usuário ou recuperados do perfil;<br>- O resultado deve apresentar: requisitos necessários, tempo restante e valores estimados. <br>-O assistente deve suportar perguntas frequentes e explicações simples sobre regras previdenciárias. | Média          | Alta   |
...
|   História de Usuário   |    Tema    |      Critérios de aceitação     |    Prioridade    |   DI   |
| ----------------------- | ---------- | ------------------------------- | ---------------- | ------ |
| Eu, como usuário do aplicativo do INSS, desejo emitir recibos digitais das minhas transações, a fim de ter um comprovante eletrônico das minhas operações. | Gerenciamento Financeiro | - O sistema deve gerar um recibo digital para cada transação realizada pelo usuário (pagamentos, solicitações, etc.);</br> - O recibo digital deve conter informações como data da transação, valor, descrição da transação e dados do usuário;</br> - O usuário deve poder visualizar, baixar e compartilhar o recibo digital;</br> - O recibo digital deve ser gerado em formato PDF ou outro formato padrão;</br> - O sistema deve armazenar os recibos digitais em um histórico acessível pelo usuário;</br> - O usuário deve poder filtrar e buscar recibos digitais por data, tipo de transação ou outros critérios. | Alta | Alta |
...
|   História de Usuário   |    Tema    |      Critérios de aceitação     |    Prioridade    |   DI   |
| ----------------------- | ---------- | ------------------------------- | ---------------- | ------ |
| Eu, como usuário do aplicativo do INSS, desejo consultar informações sobre o meu FGTS, como saldo e extrato, a fim de ter um controle sobre meus recursos. | Gerenciamento Financeiro | - O sistema deve permitir que o usuário consulte o saldo atual do seu FGTS;</br> - O sistema deve apresentar um extrato detalhado das movimentações do FGTS, incluindo depósitos, saques e rendimentos;</br> - O sistema deve permitir que o usuário filtre o extrato por períodos;</br> - O sistema deve informar a data de aniversário da conta do FGTS;</br> - O sistema deve indicar se há alguma pendência ou restrição na conta do FGTS;</br> - O sistema deve permitir que o usuário simule um saque do FGTS (opcional). | Alta | Alta |
...
|   História de Usuário   |    Tema    |      Critérios de aceitação     |    Prioridade    |   DI   |
| ----------------------- | ---------- | ------------------------------- | ---------------- | ------ |
| Eu, como aposentado/trabalhador, desejo fazer consultas e pagamentos por meio do aplicativo do Meu INSS. | Gerenciamento Financeiro. | – O sistema deve permitir consulta do histórico de pagamento de pensões<br>– O sistema deve permitir o pagamento de parcelas pendentes das pensões<br>– O sistema deve possuir maneira de emitir boleto bancário | Alta | Alta |
...
|   História de Usuário   |    Tema    |      Critérios de aceitação     |    Prioridade    |   DI   |
| ----------------------- | ---------- | ------------------------------- | ---------------- | ------ |
| Eu, como aposentado/trabalhador, desejo realizar login no aplicativo do Meu INSS por meio da autenticação do gov.br. | Funcionalidades Gerais. |– O sistema deve permitir que o aposentado/trabalhador possa ser autenticado no aplicativo do Meu INSS por meio da autenticação do gov.br.<br>– O sistema deve redirecionar o aposentado/trabalhador para a interface do gov.br para que a autenticação seja feita por meio dele. | Alta | Media |
...
|   História de Usuário   |    Tema    |      Critérios de aceitação     |    Prioridade    |   DI   |
| ----------------------- | ---------- | ------------------------------- | ---------------- | ------ |
| Eu, como aposentado/trabalhador, desejo ter privacidade em relação aos meus dados sensíveis no uso do aplicativo do Meu INSS. | Funcionalidades Gerais. |– O sistema deve mascarar qualquer dado sensível como CPF, RG, endereço e etc. Para poder preservar a privacidade do aposentado/trabalhador. | Alta | Baixa |
...
|   História de Usuário   |    Tema    |      Critérios de aceitação     |    Prioridade    |   DI   |
| ----------------------- | ---------- | ------------------------------- | ---------------- | ------ |
| Eu, como aposentado/trabalhador, desejo visualizar meus benefícios a serem recebidos com um detalhamento maior. | Planejamento Previdenciário e Benefícios. |– O sistema deve permitir a consulta de dados mais específicos sobre os benefícios a serem recebidos. | Alta | Media |
...
|   História de Usuário   |    Tema    |      Critérios de aceitação     |    Prioridade    |   DI   |
| ----------------------- | ---------- | ------------------------------- | ---------------- | ------ |
| Eu, como aposentado/trabalhador, desejo ter acesso a um calendário para que possa me organizar de acordo com as datas dos pagamentos pendentes. | Comunicação e Informações. |– O sistema deve fornecer um calendário com as datas dos pagamentos pendentes em evidencia. | Media | Alta |
